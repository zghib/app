...
export default {
  about_directus: "O aplikacji Directus",
  activity: "Aktywność",
  activity_log: "Log aktywności",
  activity_outside_directus: "Element utworzony poza Directus",
  add_field_filter: "Dodaj filtrowanie po polu",
  add_new: "Dodaj nowy",
  ...
  api_installed: "API pomyślnie zainstalowane",
  api_url: "API URL",
  auto_generate: "Automatycznie generuj",
  auto_generated: "Automatycznie wygenerowane...",
  batch: "Grupowo",
  batch_delete: "Grupowe usunięcie",
  ...
  batch_edit: "Grupowa edycja elementów: {collection}",
  between: "Pomiędzy",
  ...
  cant_sort_by_this_field: "Nie możesz sortować po tym polu",
  change_project: "Zmień projekt",
  choose_interface: "Wybierz interfejs za pomocą którego te dane będą edytowane.",
  ...
  "collections-directus_activity": "Aktywności",
  "collections-directus_files": "Pliki",
  "collections-directus_users": "Użytkownicy",
  ...
  creating_item: "Tworzenie elementu",
  creating_item_page_title: "Tworzenie elementu: {collection}",
  creating_role: "Tworzenie roli",
  currently_selected: "Obecnie zaznaczony: {thing}",
  database_connection: "Połączenie z bazą danych",
  database_connection_copy:
    "Następnie, potrzebujemy wiedzieć jak połączyć się z bazą danych, przy pomocy której będzie zarządzany ten projekt.",
  datatype: "Typ danych",
  datatypes: {
    mysql: {
      BIGINT:
      ...
      BOOLEAN: "Prawda lub fałsz. Zapisywany odpowiednio przy pomocy 1 lub 0.",
      CHAR:
      ...
      INT:
        "Liczba całkowita. Jeśli zapisywana ze znakiem przyjmuje liczby z zakresu od -2,147,483,648 do 2,147,483,647, bez znaku od 0 do 4,294,967,295.",
      LONGTEXT: "Tekst o długości nieprzekraczającej 4,294,967,295 znaków.",
      MEDIUMINT:
        "Liczba całkowita. Jeśli zapisywana ze znakiem przyjmuje liczby z zakresu od -8,388,608 do 8,388,607, bez znaku od 0 do 16,777,215.",
      MEDIUMTEXT: "Tekst o długości nieprzekraczającej 16,777,215 znaków.",
      SMALLINT:
        "Liczba całkowita. Jeśli zapisywana ze znakiem przyjmuje liczby z zakresu od -32,768 do 32,767, bez znaku od 0 do 65,535.",
      TEXT: "Tekst o długości nieprzekraczającej 65,535 znaków.",
      ...
      TINYINT:
        "Liczba całkowita. Jeśli zapisywana ze znakiem przyjmuje liczby z zakresu od -128 do 127, bez znaku od 0 do 255.",
      TINYTEXT: "Tekst o długości nieprzekraczającej 255 znaków.",
      VARCHAR:
        "Pole znakowe o zmiennej długości z zakresu od 1 do 255 bajtów. Zajmowany jest jedynie taki obszar pamięci, jakiego wymaga wartość wstawiona w to pole.",
      YEAR: "Rok z przedziału pomiędzy  `1901`, a `2155`, lub `0000`"
    }
  },
  date_and_time: "Data i czas",
  db_column_name: "Nazwa kolumny w bazie danych...",
  db_datatype: "{db} typ danych",
  db_name: "Nazwa bazy danych",
  db_password: "Hasło użytkownika bazy danych",
  db_type: "Typ bazy danych",
  db_update_failed: "Baza danych nie mogła zostać zaktualizowana.",
  db_updated: "Baza danych została zaktualizowana poprawnie",
  ...
  dont_manage: "Nie zarządzaj",
  dont_manage_copy:
    "Przywileje oraz ustawienia dla kolekcji {collection} zostaną usunięte z systemu na stałe! Na pewno chcesz wykonać tę operację?",
  dont_show: "Nie pokazuj",
  drop_files: "Nie można upuścić plików | Upuść plik tutaj... | Upuść pliki tutaj...",
  duplicate: "Zduplikuj",
  duplicating_field: "Duplikuję pole",
  editing: "Edycja elementu: {collection}",
  editing_item: "Edycja elementu",
  editing_items: "Grupowa edycja {count} elementów",
  editing_my_profile: "Edytowanie mojego profilu",
  editing_single: "Edycja {collection}",
  email: "Email",
  email_address: "Adres email",
  embed: "Osadzony",
  embed_placeholder: "YouTube, Vimeo, lub inny link",
  empty_collection: "Pusta kolekcja",
  empty_collection_body: "Nie ma jeszcze żadnych elementów w tej kolekcji.",
  enable_manual_sorting: "Włącz ręczne sortowanie",
  enter_collection_name: "Wpisz nazwę kolekcji...",
  enter_role_name: "Wpisz nazwę roli...",
  enter_value: "Wpisz wartość",
  environment: "Środowisko",
  equal_to: "Równe z",
  error_unknown: "Nastąpił nieznany błąd. Spróbuj ponownie później.",
  errors: {
    "11": "Nie można nawiązać połączenia z bazą danych",
    "100": "Zły login i/lub hasło",
    "101": "Wylogowano ze względu na brak aktywności",
    "102": "Wylogowano ze względu na brak aktywności",
    "103": "Użytkownik nieaktywny",
    "106": "Zły login i/lub hasło",
    "107": "Użytkownik nie odnaleziony",
    "-1": "Nie udało połączyć się z API"
  },
  esc_cancel: "Naciśnięcie klawisza escape spowoduje anulowanie i zamknięcie okna.",
  event_count: "Brak wydarzeń | Jedno wydarzenie| {count} wydarzenia/ń",
  existing: "Istniejące",
  ...
  fieldtypes: {
    ...
    datetime_created:
      "Pole systemowe do przetrzymywania informacji o dacie i czasie w którym element został stworzony, wykorzystywane przez rewizje",
    datetime_updated:
      "Pole systemowe do przetrzymywania informacji o dacie i czasie w którym element był aktualizowany, wykorzystywane przez rewizje",
    decimal: "Liczba zmiennoprzecinkowa",
    file: "Klucz obcy nawiązujący do directus_files.id",
    group:
      "Grupuje pola razem pod względem wizualnym - pola-dzieci zapisują grupy do directus_fields.group",
    integer: "Liczba całkowita",
    json: "Standardowy format JSON zwracany przez API",
    ...
    translation:
      "Charakterystyczne dla przekładów, przetrzymuje wielojęzykową treść w relacji jeden-do-wielu",
    user_created:
      "Pole systemowe do przetrzymywania informacji o autorze elementu, wykorzystywane przez rewizje",
    user_updated:
      "Pole systemowe do przetrzymywania informacji o użytkowniku, który aktualizował element, wykorzystywane przez rewizje",
    uuid: "Universally Unique Identifier"
  },
  file: "Plik",
  file_library: "Biblioteka plików",
  file_type_not_accepted:
    "{filename} nie może zostać wgrany. Nie jest to prawidłowy typ pliku dla tego pola.",
  file_upload: "Wgrany plik(i)",
  forgot_password: "Zapomniałem hasła",
  greater_than: "Większe od",
  greater_than_equal: "Większe lub równe od",
  help_and_docs: "Pomoc i dokumentacja",
  hidden: "Ukryte",
  hidden_browse: "Ukryte podczas przeglądania",
  hidden_detail: "Ukryte w detalu",
  host: "Host",
  icon: "Ikona",
  in_list: "Jeden z tych",
  info: "Info",
  initial_schema: "Wybierz początkowy schemat",
  initial_schema_copy:
    "Wybierz spośród istniejących architektur baz danych lub utwórz nową. Zawsze możesz rozszerzyć lub zmienić to ustawienie później.",
  install: "Zainstaluj",
  install_copy:
    "To API nie zostało jeszcze skonfigurowane. Chcesz przeprowadzić instalację oraz konfigurację teraz?",
  intelligent_defaults:
    "Ustawienia zaawansowane pozwalają Ci na skonfigurowanie sposobu przechowywania danych w bazie danych oraz na edycję dodatkowych ustawień aplikacji.",
  interface: "Interfejs",
  interface_count: "Brak interfejsu | Jeden interfejs | {count} interfejsy/ów",
  interface_settings:
    "Każdy interfejs może być skrojony na miarę Twoich potrzeb. Poniżej znajdują się dostępne ustawienia tego interfejsu, ale tylko niektóre są wymagane.",
  interfaces: "Interfejsy",
  is_empty: "Jest pusty",
  is_not_null: "Nie jest NULLem",
  is_null: "Jest NULLem",
  item_count: "Brak elementów | Jeden element | {count} elementy/ów",
  item_count_filter:
    "Brak odfiltrowanych elementów | Jeden odfiltrowany element | {count}filtrowane elementy/ów",
  item_deleted: "Element usunięty",
  item_saved: "Element zapisany | {count} elementy zapisane",
  ...
  length: "Długość",
  length_disabled_placeholder: "Długość jest określona przez typ danych",
  less_than: "Mniejsze od",
  less_than_equal: "Równe lub mniejsze od",
  limited: "Ograniczone",
  loading: "Wczytywanie...",
  loading_more: "Wczytywanie kolejnych elementów...",
  login: "Zaloguj się",
  m2m: "Wiele-do-wielu (M2M)",
  m2o: "Wiele-do-jednego (M2O)",
  manage: "Zarządzaj",
  manage_started: "Rozpoczęto zarządzanie {collection}",
  manage_stopped: "Zakończono zarządzenie {collection}",
  max_one_primary_key: "Możesz mieć tylko jeden klucz podstawowy w kolekcji",
  max_size: "Maks. wielkość: {size}",
  mixed: "Mieszany",
  modified_by: "Modyfikowane Przez",
  modified_on: "Modyfikowane Dnia",
  more_options: "Więcej opcji",
  my_activity: "Moje aktywność",
  my_profile: "Mój profil",
  name: "Nazwa",
  name_bookmark: "Jak chciałbyś nazwać tę zakładkę?",
  name_field: "Nazwij pole {field} i dodaj pomocny dla użytkowników opis.",
  navigate_changes:
    "Na pewno chcesz opuścić tę stronę? Wszelkie zmiany, których dokonałeś zostaną utracone jeśli to zrobisz.",
  new: "Nowy",
  new_field: "Nowe pole",
  new_file: "Nowy plik",
  next: "Następny",
  ...
  no_interface_error: "Pole {field} nie ma skonfigurowanego interfejsu",
  no_related_entries: "Nie ma żadnych powiązanych wpisów",
  no_results: "Brak wyników",
  no_results_body: "Żaden element kolekcji nie spełnia obecnych filtrów",
  none: "Żaden",
  not_between: "Nie pomiędzy",
  not_contains: "Nie zawiera",
  not_empty: "Nie jest puste",
  not_equal_to: "Nie jest równe z",
  not_in_list: "Nie jest jednym z tych",
  note: "Notatka",
  ...
  popular: "Popularne",
  port: "Port",
  powered_by_directus: "Zasilane przez Directus",
  preview_and_revert: "Podglądnij i cofnij",
  primary_key: "Klucz podstawowy",
  project: "Projekt",
  project_info: "Informacje nt. projektu",
  project_info_copy:
    "Poniżej znajduje się kilka pytań odnośnie Twojego projektu, włączając w to pola na wpisanie danych logowania do Twojego pierwszego konta administracyjnego.",
  project_key: "Klucz projektu",
  project_name: "Nazwa projektu",
  read: "Odczyt",
  readable_fields: "Odczytywalne pola",
  readable_fields_copy: "Wybierz te pola, które użytkownik może zobaczyć",
  readonly: "Tylko do odczytu",
  regex: "RegEx",
  related_collection: "Powiązana kolekcja",
  related_entries: "Ma powiązane wpisy",
  relation_setup:
    "Ponieważ to jest relacyjne pole potrzebujemy określić powiązane z nim, inne pola.",
  relation_setup_copy:
    "Są różne typy danych relacyjnych, ten interfejs wykorzystuje jeden z nich zwany {relation}.",
  relational: "Relacyjny",
  relationship: "Powiązanie",
  remove: "Usuń",
  remove_related: "Usuń powiązany element",
  report_issue: "Zgłoś błąd",
  request_feature: "Zaproponuj nową funkcjonalność",
  required: "Wymagane",
  reset_password: "Resetuj hasło",
  reset_preferences: "Resetuj wszystkie preferencje",
  revert: "Przywróć",
  revert_copy: "Na pewno chcesz przywrócić stan tego elementu z dnia {date}?",
  role_count: "Brak ról | Jedna rola | {count} ról",
  role_settings: "Ustawienia ról",
  roles: "Role użytkownika",
  save: "Zapisz",
  save_and_add: "Zapisz i dodaj nowy",
  save_and_stay: "Zapisz i zostań",
  save_as_bookmark: "Zapisz jako zakładkę",
  ...
  select_from_device: "Wybierz z urządzenia",
  ...
  settings: "Ustawienia",
  settings_collections_fields: "Kolekcje i pola",
  ...
  settings_update_database: "Aktualizuj bazę danych",
  settings_update_database_confirm:
    "Wykonanie tej akcji spowoduje zaktualizowanie pół systemowych w Twojej bazie danych do najnowszej wersji Directusa. Zanim będziesz kontynuował upewnij się, że wykonałeś kopię zapasową danych.",
  settings_update_database_subtext: "Uruchom skrypt",
  ...
  sign_out_confirm_edits:
    "Na pewno chcesz się wylogować? Wszystkie niezapisane zmiany zostaną utracone.",
  signing_in: "Rejestrowanie",
  single: "Pojedynczy",
  something_went_wrong: "Coś poszło nie tak.",
  something_went_wrong_body:
    "Wystąpił problem podczas przetwarzania żądania. Odśwież stronę i spróbuj ponownie.",
  sort: "Sortuj",
  sort_by: "Sortuj po",
  spacing: "Odstępy",
  status: "Status",
  ...
  to: "Do",
  unique: "Unikalne",
  unsaved_changes_copy: "Niezapisano zmian! Czy na pewno chcesz opuścić tę stronę?",
  update: "Aktualizuj",
  update_confirm: "Jesteś pewien, że chcesz zaktualizować {count} elementów?",
  update_field: "Aktualizuj pole",
  upload_exceeds_max_size:
    "{filename} nie może zostać wgrany. Twój serwer nie jest odpowiednio skonfigurowany, by mój przyjmować pliki tej wielkości.",
  user_directory: "Katalog użytkownika",
  user_edit_warning:
    "{first_name} {last_name} również aktualnie dokonuje edycji tego element. Proszę skoordynuj z nim pracę, by nie utracić swoich zmian.",
  ...
  welcome: "Witaj",
  writable_fields: "Edytowalne pola",
  writable_fields_copy: "Wybierz pola, które użytkownik będzie mógł edytować",
  yes: "Tak"
};

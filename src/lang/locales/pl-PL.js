...
export default {
  ...
  activity: "Aktywności",
  my_activity: "Moje aktywności",
  activity_log: "Log aktywności",
  activity_outside_directus: "Ten element został utworzony poza Directus.",
  ...
  name: "Nazwa",
  name_field: "Nazwij pol {field} i dodaj pomocny dla użytkowników opis.",
  navigate_changes:
  ...
  request_feature: "Zaproponuj funkcjonalność",
  regex: "RegEx",
  relation_setup:
  ...
  signing_in: "Rejestracji",
  sign_out: "Wylogowuj się",
  ...
  unique: "Unikalne",
  user_edit_warning:
    "Aktualnie {first_name} {last_name} również edytuje ten element. Proszę skoordynuj z nim pracę, by nie utracić swoich zmian.",
  value: "Wartość",
  values: "Wartości",
